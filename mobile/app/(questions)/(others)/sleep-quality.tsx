...
const Page = () => {
  ...
  const { health, academicEngagement } = useLocalSearchParams<{
    health: string;
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={{ flex: 1, backgroundColor: COLORS.main }}>
        ...
        >
          <MaterialIcons name="bedtime" size={40} color={COLORS.white} />
          <Text
            style={{
        ...
        >
          <Form
            question="How quality was your last sleep?"
            onNext={() => {
              router.navigate({
                pathname: "/(questions)/(others)/study-hours-week",
                params: {
                  health,
                  sleepQuality: state.value,
                  academicEngagement,
                },
              });
            }}
