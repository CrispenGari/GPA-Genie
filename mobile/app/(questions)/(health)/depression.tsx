...
const Page = () => {
  ...
  const { anxiety } = useLocalSearchParams<{ anxiety: string }>();
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={{ flex: 1, backgroundColor: COLORS.main }}>
        ...
        >
          <Form
            question="Do you have depression today?"
            onNext={() => {
              router.navigate({
                pathname: "/(questions)/(health)/mental-health-support",
                params: {
                  anxiety,
                  depression: state.value,
                },
              });
            }}
            onPrevious={() => {
