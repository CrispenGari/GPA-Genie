...
const Page = () => {
  ...
  const { anxiety, depression, mentalHealthSupport, panicAttacks } =
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={{ flex: 1, backgroundColor: COLORS.main }}>
        ...
        >
          <Form
            question="Do you any specialist treatment?"
            onNext={() => {
              router.navigate({
                pathname: "/(questions)/(health)/symptom-frequency",
                params: {
                  anxiety,
                  specialistTreatment: state.value,
                  depression,
                  mentalHealthSupport,
                  panicAttacks,
                },
