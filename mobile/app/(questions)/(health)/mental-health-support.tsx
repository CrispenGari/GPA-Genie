...
const Page = () => {
  ...
  const { anxiety, depression } = useLocalSearchParams<{
    anxiety: string;
    depression: string;
  }>();
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={{ flex: 1, backgroundColor: COLORS.main }}>
        ...
        >
          <Form
            question="Do you have any mental health support?"
            onNext={() => {
              router.navigate({
                pathname: "/(questions)/(health)/panic-attack",
                params: {
                  anxiety,
                  mentalHealthSupport: state.value,
                  depression,
                },
              });
            }}
